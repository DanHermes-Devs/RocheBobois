        ...
        <div class="row">
            <div class="col-12 px-0">
                ...
                <section class="stretcher-wrapper">
                    ...
                    <ul class="stretcher">
                        @foreach ($buildings_category as $building)
                            <li class="stretcher-item" style="background-image: url({{ asset('storage/' . $building->imagen_destacada) }})">
                                <!--logo-item-->
                                ...
                                <!--anchor-->
                                <a href="{{ route('building.show', $building->slug) }}" class="stretcher-link"></a>
                            </li>
                        @endforeach
                    </ul>
                </section>
